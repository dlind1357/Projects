# The configuration of sessions as well as the logout functions were taken from CS50’s problem set 9 assignment while the rest of the file was written by me.
